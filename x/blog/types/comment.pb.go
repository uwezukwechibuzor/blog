...
func (m *MsgCreateComment) GetT() int64 {
	if m != nil {
		return m.T
	}
	return 0
...
var fileDescriptor_7734d44b462eebbe = []byte{
	...
	0x17, 0x5b, 0x41, 0x7e, 0x71, 0x89, 0xa7, 0x8b, 0x04, 0x0b, 0x58, 0x14, 0xca, 0x53, 0x4a, 0xe3,
	0x12, 0xf0, 0x2d, 0x4e, 0x77, 0x06, 0x99, 0x94, 0x4a, 0xd8, 0x26, 0x98, 0xc9, 0x4c, 0x58, 0x4d,
	0x66, 0x46, 0x36, 0x59, 0x88, 0x87, 0x8b, 0xb1, 0x04, 0x6c, 0x19, 0x73, 0x10, 0x63, 0x89, 0x93,
	...
	0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x43, 0x83, 0x45, 0x1f, 0x1c, 0x64, 0x15, 0x10, 0xaa,
	0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0x1c, 0x1e, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff,
	0x21, 0xc1, 0x90, 0x8b, 0x4e, 0x01, 0x00, 0x00,
}
...
func (m *MsgCreateComment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.T != 0 {
		i = encodeVarintComment(dAtA, i, uint64(m.T))
		i--
		dAtA[i] = 0x20
	}
	if len(m.PostID) > 0 {
